    ...
    public partial class Form1 : Form
    {
        ...
        public void DrawStar(Pen starPen, float x, float y, float pixels)
        {
           ...
           /* g.DrawLine(starPen, 80 * scale + x, 77 * scale + y, 103 * scale + x, 4 * scale + y);
            ...
            starPoints[0] = new PointF(80 * scale + x, 77 * scale + y);
            starPoints[1] = new PointF(103 * scale + x, 4 * scale + y);
            starPoints[2] = new PointF(126 * scale + x, 78 * scale + y);
            starPoints[3] = new PointF(207 * scale + x, 78 * scale + y);
            starPoints[4] = new PointF(143 * scale + x, 125 * scale + y);
            starPoints[5] = new PointF(167 * scale + x, 197 * scale + y);
            starPoints[6] = new PointF(103 * scale + x, 152 * scale + y);
            starPoints[7] = new PointF(40 * scale + x, 196 * scale + y);
            starPoints[8] = new PointF(63 * scale + x, 123 * scale + y);
            starPoints[9] = new PointF(0 * scale + x, 77 * scale + y);
        ...
        /// <param name="pixels">Side lengths of the square within which the star is drawn</param>
        public void FillStar(SolidBrush starPen, float x, float y, float pixels)
        {
            ...
            g.FillPolygon(starPen, starPoints);
        }
    }
}
